...
void Settings::applyDefaults() {
    ...
    if (!mod->setSavedValue("defaults_set_17", true)) {
        mod->setSavedValue("attempts_showcase_min", static_cast<int64_t>(5));
        mod->setSavedValue("attempts_showcase_max", static_cast<int64_t>(78));
    }
